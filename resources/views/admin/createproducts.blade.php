          ...
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="number"  step="0.5" min="0" id="price" class="form-control" required name="price">
              </div>              
            </div>            
          </div>
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="number" min="0" id="quantity" class="form-control" required name="quantity">
              </div>              
            </div>            
          </div>
          <div class="row">
