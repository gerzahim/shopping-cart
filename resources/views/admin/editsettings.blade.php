      ...
      <div class="table-responsive cart_info">
        <form action="{{ route('settings.update', ['id' => $setting['id']]) }}" method="post" id="edit-form" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="form-group">
                <label for="card-name" id="msgtxtimg" name="msgtxtimg">Image Logo Home Current <br>#suggest (width=150px ; Height=120px)
                </label>
                <br>                 
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="form-group">
                <label for="card-name" id="msgtxtimg" name="msgtxtimg">Image Lema Current <br>#suggest (width=380px ; Height=100px)
                </label> 
                <br>               
                ...
                <label for="card-name">Check If Want To Change Current Image Lema</label>
                <input type="file" id="lema_home" name="lema_home" accept="image/*">
              </div>              
            </div>            
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="form-group">
                <label for="card-name" id="msgtxtimg" name="msgtxtimg">Image Logo Admin Current <br>#suggest (width=60px ; Height=50px)
                </label>
                <br>                 
                <img width="60px" src="{{ URL::to('/') }}/images/{{ $setting['logo_home'] }}" alt="No Images" name="imagepath">
                <br><br> 
                ...
                <input type="file" id="logo_home" name="logo_admin" accept="image/*">
              </div>              
            </div>            
          </div>
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                <label for="name" id="text_redl" name="text_red">Logo Admin Height - pixels</label>
          ...
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                <label for="name" id="text_redl" name="text_red">Logo Admin Width - pixels</label>
          ...
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="text" id="especial_prod_id1" class="form-control" name="especial_prod_id1" value="{{ $setting['especial_prod_id1'] }}" >
              </div>              
            </div>            
          </div>
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="text" id="especial_prod_id2" class="form-control" name="especial_prod_id2" value="{{ $setting['especial_prod_id2'] }}" >
              </div>              
            </div>            
          </div>
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="text" id="especial_prod_id3" class="form-control" name="especial_prod_id3" value="{{ $setting['especial_prod_id3'] }}" >
              </div>              
            </div>            
          </div> 
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="text" id="especial_prod_id4" class="form-control" name="especial_prod_id4" value="{{ $setting['especial_prod_id4'] }}" >
              </div>              
            </div>            
          </div> 
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="text" id="especial_prod_id5" class="form-control" name="especial_prod_id5" value="{{ $setting['especial_prod_id5'] }}" >
              </div>              
            </div>            
          </div> 
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="text" id="especial_prod_id6" class="form-control" name="especial_prod_id6" value="{{ $setting['especial_prod_id6'] }}" >
              </div>              
            </div>            
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="number" id="especial_prod_id3" class="form-control" name="quick_cat_id3" value="{{ $setting['quick_cat_id3'] }}" >
              </div>              
            </div>            
          </div> 
          <div class="row">
