        ...
        <div class="row">   
          ...
          <div class="col-sm-4">
            <div class="contact-info">
              ...
              <address>
                <p><?php echo e($setting->name_site); ?></p>
                <p><?php echo e($setting->address_site); ?></p>
                <p>Phone: <?php echo e($setting->phone_site); ?> </p>
                <p>Email: <?php echo e($setting->email_site); ?></p>
              </address>
              <?php /*               
              <!--
              <address>
              ...
              */ ?>
              ...
              <ul>
                <li>
                  <a href="<?php echo e($setting->link_facebook); ?>"><i class="fa fa-facebook"></i></a>
                </li>
                <li>
                  <a href="<?php echo e($setting->link_twitter); ?>"><i class="fa fa-twitter"></i></a>
                </li>
                <?php /* 
                <li>
                  <a href="<?php echo e($setting->link_google_plus); ?>"><i class="fa fa-google-plus"></i></a>
                </li>
                */ ?>
                <li>
                  <a href="<?php echo e($setting->link_linkedin); ?>"><i class="fa fa-instagram"></i></a>
                </li>
              </ul>
              </div>
            </div>
